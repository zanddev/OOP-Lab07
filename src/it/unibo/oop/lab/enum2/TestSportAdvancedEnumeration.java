...
public final class TestSportAdvancedEnumeration {
	 ...
	 * {@link it.unibo.oop.lab.enum2.Sport2SocialNetworkUserImpl}.
	 * 
	 * @param args
	 *            ignored
	 */
	public static void main(final String... args) {
		/*
		 * create 2 social network users (Sport2SocialNetworkUser):
		...
		// Cassani practised bike and loves F1 and MotoGP:
